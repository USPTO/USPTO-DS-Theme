...
We’re so glad you’re thinking about contributing to an USPTO open source project! If you’re unsure about anything, just ask — or submit your issue or pull request anyway. The worst that can happen is we’ll politely ask you to change something. We appreciate all friendly contributions.


We encourage you to read this project’s CONTRIBUTING policy (you are here), and it's [LICENSE](LICENSE.md).

If you have any questions [send us an email](uxb@uspto.gov).
...
[Open an issue](https://github.com/uspto/USPTO-DS-Theme/issues/new) if you have questions or need help with setup.
...
The rest of this project is in the worldwide [public domain](https://github.com/uspto/USPTO-DS-Theme/LICENSE.md).
